...
class SharePointAPI:
    ...
    def download_list_items(self, list, view_name=None, fields=None, query=None, row_limit=0): 
        """ 
        ...
        """ 
        try: 
            list_items = list.GetListItems(view_name=view_name, fields=fields, query=query, row_limit=row_limit) 
        except: 
            # We should log the specific type of error occurred. 
