            ...
            if sent_single["@timestamp"] <= (datetime.now() - timedelta(minutes=60)):
                ...
                for successful_single in successful:
                    ...
                    if agent_sent == agent_successful:
                        timediff = (
                            successful_single["@timestamp"] - sent_single["@timestamp"]
                        )
